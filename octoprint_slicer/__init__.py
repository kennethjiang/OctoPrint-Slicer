...
class SlicerPlugin(octoprint.plugin.SettingsPlugin,
	...
	def get_assets(self):
		...
		# core UI here.
		return dict(
			js=["js/profile_overrides.js", "js/three.min.js", "js/packer.growing.js", "js/STLLoader.js", "js/OrbitControls.js", "js/Detector.js", "js/STLBinaryExporter.js", "js/ModelArranger.js", "js/GeometryUtils.js", "js/octoprint_slicer.min.js"],
			css=["css/slicer.css"],
