...
TransformGizmo$1.prototype = Object.create(THREE$1.Object3D.prototype);
TransformGizmo$1.prototype.constructor = THREE$1.TransformGizmo;
...
function OrbitControls$1(object, domElement) {
    ...
    // Mouse buttons
    this.mouseButtons = { ORBIT: THREE$1.MOUSE.LEFT, ZOOM: THREE$1.MOUSE.MIDDLE, PAN: THREE$1.MOUSE.RIGHT };
    ...
    var pan = function () {
        ...
        return function pan(deltaX, deltaY) {
            ...
            if (scope.object instanceof THREE$1.PerspectiveCamera) {
            ...
            } else if (scope.object instanceof THREE$1.OrthographicCamera) {
...
OrbitControls$1.prototype = Object.create(THREE$1.EventDispatcher.prototype);
OrbitControls$1.prototype.constructor = THREE$1.OrbitControls;
...
STLBinaryExporter.prototype = {
    ...
    parse: function () {
        ...
        var normalMatrixWorld = new THREE$1.Matrix3();
        ...
        return function parse(scene) {
            ...
            scene.traverse(function (object) {
                ...
                if (!(object instanceof THREE$1.Mesh)) return;

                var geometry = object.geometry;
                if (geometry instanceof THREE$1.BufferGeometry) {

                    geometry = new THREE$1.Geometry().fromBufferGeometry(geometry);
                }

                if (!(geometry instanceof THREE$1.Geometry)) return;
...
function STLViewPort(canvas, width, height, onChange, onNewModel) {
    ...
    self.init = function () {
        ...
        self.orbitControls = new OrbitControls$1(self.camera, self.renderer.domElement);
...
function ModelArranger() {
    ...
    function projectedRectOnXY(model) {
        var margin = 10.0;
        var modelBox = new THREE$1.Box3().setFromObject(model);
